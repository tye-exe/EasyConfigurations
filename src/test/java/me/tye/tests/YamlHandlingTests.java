...
import me.tye.easyconfigs.YamlHandling;
import me.tye.easyconfigs.utils.exceptions.DefaultConfigurationException;
import me.tye.easyconfigs.utils.exceptions.NotSupportedException;
import me.tye.easyconfigs.utils.exceptions.YamlParseException;
import me.tye.tests.instancesTests.parseInternalYamlFormattingTest.Config_Empty;
import me.tye.tests.instancesTests.parseYamlTest.*;
...
import static me.tye.easyconfigs.YamlHandling.parseInternalYaml;
...
private static Stream<Arguments> yaml_string_provider() {
  return Stream.of(
      ...
      arguments("/tests/Yamls/parseInternalYamlFormattingTest/Config_General.yml", me.tye.tests.instancesTests.parseInternalYamlFormattingTest.Config_General.class, formattedMap_General)
  );
}
...
void parseInternalYamlFormattingWithNull() {
  assertThrowsExactly(YamlParseException.class, () -> parseInternalYaml(
          me.tye.tests.instancesTests.parseInternalYamlFormattingTest.Config_HasNull.class, "/tests/Yamls/parseInternalYamlFormattingTest/Config_HasNull.yml"),
...
private static Stream<Arguments> instance_provider() {
  return Stream.of(
      arguments(me.tye.tests.instancesTests.parseYamlTest.Config_Empty.class, "/tests/Yamls/parseYamlTest/Config_Empty.yml", true, null),
      arguments(me.tye.tests.instancesTests.parseYamlTest.Config_General.class, "/tests/Yamls/parseYamlTest/Config_General.yml", true, null),
      ...
      arguments(me.tye.tests.instancesTests.parseYamlTest.Config_HasNull.class, "/tests/Yamls/parseYamlTest/Config_HasNull.yml", false, YamlParseException.class)
  );
}
