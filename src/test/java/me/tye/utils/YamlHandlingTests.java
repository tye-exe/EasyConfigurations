...
import me.tye.utils.instancesTests.parseInternalYamlFormattingTest.Config_Empty;
import me.tye.utils.instancesTests.parseInternalYamlFormattingTest.Config_General;
import me.tye.utils.instancesTests.parseYamlTest.*;
...
import static me.tye.utils.YamlHandling.parseInternalYaml;
...
private static Stream<Arguments> yaml_string_provider() {
  return Stream.of(
      arguments("/testYaml/parseInternalYamlFormattingTest/Config_Empty.yml", Config_Empty.class, map_Empty),
      arguments("/testYaml/parseInternalYamlFormattingTest/Config_General.yml", me.tye.utils.instancesTests.parseInternalYamlFormattingTest.Config_General.class, formattedMap_General)
  );
}
...
void parseInternalYamlFormattingWithNull() {
  assertThrowsExactly(YamlParseException.class, () -> parseInternalYaml(
          me.tye.utils.instancesTests.parseInternalYamlFormattingTest.Config_HasNull.class, "/testYaml/parseInternalYamlFormattingTest/Config_HasNull.yml"),
...
private static Stream<Arguments> instance_provider() {
  return Stream.of(
      arguments(me.tye.utils.instancesTests.parseYamlTest.Config_Empty.class, "/testYaml/parseYamlTest/Config_Empty.yml", true, null),
      arguments(me.tye.utils.instancesTests.parseYamlTest.Config_General.class, "/testYaml/parseYamlTest/Config_General.yml", true, null),
      arguments(Config_Arrays.class, "/testYaml/parseYamlTest/Config_Arrays.yml", true, null),
      arguments(Config_DefaultConfiguration.class, "/testYaml/parseYamlTest/Config_DefaultConfiguration.yml", false, DefaultConfigurationException.class),
      arguments(Lang_ArrayFail.class, "/testYaml/parseYamlTest/Lang_ArrayFail.yml", false, DefaultConfigurationException.class),
      arguments(Lang_General.class, "/testYaml/parseYamlTest/Lang_General.yml", true, null),
      arguments(Lang_Extra_Yaml.class, "/testYaml/parseYamlTest/Lang_Extra_Yaml.yml", true, null),
      arguments(Config_NotSupported.class, "/testYaml/parseYamlTest/Config_NotSupported.yml", false, NotSupportedException.class),
      arguments(me.tye.utils.instancesTests.parseYamlTest.Config_HasNull.class, "/testYaml/parseYamlTest/Config_HasNull.yml", false, YamlParseException.class)
  );
}
