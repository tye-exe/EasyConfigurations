...
/**
 This exception is thrown when you try &amp; retrieve a config as a class it wasn't assigned as in the enum.<br>
 <br>
 For example:<br>
 ...
 <br>
 The methods ".getAsObject()", ".getAsString()", &amp; ".getAsBoolean()" can always be used regardless of the marked class in the enum. */
@ExternalUse
