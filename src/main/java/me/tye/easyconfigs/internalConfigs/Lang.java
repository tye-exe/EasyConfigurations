...
import me.tye.easyconfigs.utils.annotations.NotImplemented;
...
@Contract(pure = true)
@InternalUse
public static @NotNull String parsedNull(@NotNull String yamlPath) {
  switch (Config.getLanguage()) {

  case ENGLISH: return "\"" + yamlPath + "\" was parsed as a null value. It will be replaced with the string \"null\"";
  default: return  "";
